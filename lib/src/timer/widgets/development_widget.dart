...
class DevelopmentWidgetState extends ConsumerState<DevelopmentWidget> with SingleTickerProviderStateMixin {
  ...
  List<Widget> developmentTimeParts() {
    ...
    final development = (time! - firstCrackEnd).inMilliseconds / time!.inMilliseconds;
