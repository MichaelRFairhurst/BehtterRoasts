    ...
    return FittedBox(
      child: MediaQuery(
        data: mediaData.copyWith(
            textScaler: mediaData.textScaler.clamp(maxScaleFactor: 1.1)),
        child: ToggleSwitch<int>(
          onToggle: onChanged,
            ...
            ToggleSwitchOption<int>(
              ...
              child: Text(
                ...
                style: RoastAppTheme.materialTheme.textTheme.bodyMedium
                    ?.copyWith(
                        fontWeight:
                            value == 15 ? FontWeight.w500 : FontWeight.normal),
              ),
            ),
            ToggleSwitchOption<int>(
              value: 30,
              child: Text(
                ...
                style: RoastAppTheme.materialTheme.textTheme.bodyMedium
                    ?.copyWith(
                        fontWeight:
                            value == 30 ? FontWeight.w500 : FontWeight.normal),
              ),
            ),
            ToggleSwitchOption<int>(
              value: 60,
              child: Text(
                ...
                style: RoastAppTheme.materialTheme.textTheme.bodyMedium
                    ?.copyWith(
                        fontWeight:
                            value == 60 ? FontWeight.w500 : FontWeight.normal),
              ),
            ),
          ],
        ),
